...
class Resource(object):
    ...
    def validation_response(self, e):
        """
        Method to return validation error information. 
        You will probably want to override this in your own
        `Resource` subclass.
        """
        resp = rc.BAD_REQUEST
    ...
    def __call__(self, request, *args, **kwargs):
        ...
        try:
            ...
            return self.error_handler(e, request, meth, em_format)
    ...
    def error_handler(self, e, request, meth, em_format):
        ...
        if isinstance(e, FormValidationError):
            ...
            return self.validation_response(e)
