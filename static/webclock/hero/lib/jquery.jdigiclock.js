...
(function($) {
    $.fn.extend({
        ...
        jdigiclock: function(options) {
            ...
            return this.each(function() {
                ...
                html    += '<p id="left_arrow"><img src="/static/webclock/hero/images/icon_left.png" /></p>';
                html    += '<p id="right_arrow"><img src="/static/webclock/hero/images/icon_right.png" /></p>';
    ...
    $.fn.getWeather = function(el) {
        ...
        $.getJSON('lib/proxy/' + proxy + '?location=' + el.weatherLocationCode + '&metric=' + el.weatherMetric, function(data) {
            ...
            el.find('#forecast_container').append('<div id="update"><img src="/static/webclock/hero/images/refresh_01.png" alt="reload" title="reload" id="reload" />' + el.timeUpdate + '</div>');
